...
- .blue[Don't worry too much] about stuff like
    - conditionals (e.g. "if-else" -statements), 
    - loops ("for e in x" -sort of things) and
    - user-defined functions

.blue[in the early-stage of learning] &#10145;&#65039; these can often be replaced with .blue[existing] and more .blue[intuitive] [Tidyverse](https://www.tidyverse.org/) functions + you can learn these kind of stuff in later stages!
...
## Recommended resources: Tidyverse
...
* Alison Hill: [Working with Data in the Tidyverse](https://app.datacamp.com/learn/courses/working-with-data-in-the-tidyverse) (personally don't like the data used in this course, but the contents are &#128079;)

* The above-mentioned are DataCamp courses (NB: I don't get any money from them &#129325;), and some DataCamp courses are behind the paywall &#128533; check also e.g. YouTube for free Tidyverse courses!
]
...
## Recommended resources: RMarkdown

<br>

.moderate[
* Andy Field's YouTube channel, especially videos on [R and RStudio tutorials](https://www.youtube.com/c/ProfAndyField/playlists) playlist
