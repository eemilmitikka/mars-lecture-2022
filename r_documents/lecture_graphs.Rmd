...
ggplot(ratings_merged, aes(x = date)) +
  ...
  annotate("text", x = as.POSIXct(as.Date("2019-07-30")), y = 0.4, label = "Pension\nreform", size = 5) + theme(axis.text = element_text(size = 18),
    plot.title = element_text(size = 19)) + theme(axis.title = element_text(size = 15))
